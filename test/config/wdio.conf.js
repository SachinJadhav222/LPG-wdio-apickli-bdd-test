...
exports.config = {
  ...
  //
  specs: [featureFilePathUI],
  // Patterns to exclude.
  exclude: [featureFilePathAPI],
  //
  // ============
  // Capabilities
  // ============
  ...
  logLevel: "error",
  colouredLogs: true,
  screenshotsPath: screenshotPath,
  //
  ...
  cucumberOpts: {
    ...
    //format: [require.resolve('cucumber-pretty')], // <string[]> (type[:path]) specify the output format, optionally supply PATH to redirect formatter output (repeatable)
    ...
    scenshotsDirectory: screenshotPath,
  },
